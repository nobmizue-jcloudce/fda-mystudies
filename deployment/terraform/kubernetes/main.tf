...
resource "kubernetes_secret" "shared_secrets" {
  ...
  data = {
    consent_bucket_name               = "mystudies-dev1-mystudies-consent-documents"
    study_resources_bucket_name       = "mystudies-dev1-mystudies-study-resources"
    institution_resources_bucket_name = "mystudies-dev1-mystudies-institution-resources"
    base_url                          = "https://participants.mystudies-dev1.jcloudce.com"
    studies_base_url                  = "https://studies.mystudies-dev1.jcloudce.com"
    firestore_project_id              = "mystudies-dev1-firebase"
...
resource "google_service_account_key" "apps_service_account_keys" {
  ...
  service_account_id = "${each.key}@mystudies-dev1-apps.iam.gserviceaccount.com"
}
