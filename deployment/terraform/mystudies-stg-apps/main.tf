...
module "project" {
  ...
  name                    = "mystudies-stg-apps"
  org_id                  = ""
  folder_id               = "1055908109556"
  billing_account         = "00584D-616AD1-DBFCA2"
  lien                    = true
  default_service_account = "keep"
  skip_gcloud_download    = true
  shared_vpc              = "mystudies-stg-networks"
  shared_vpc_subnets = [
    "projects/mystudies-stg-networks/regions/asia-northeast1/subnetworks/mystudies-stg-gke-subnet",
  ]
  activate_apis = [
...
module "mystudies_stg" {
  source  = "terraform-google-modules/cloud-dns/google"
  version = "~> 3.0.0"

  name       = "mystudies-stg"
  project_id = module.project.project_id
  domain     = "mystudies-stg.jcloudce.com."
  type       = "public"
...
module "mystudies_stg_gke_cluster" {
  source  = "terraform-google-modules/kubernetes-engine/google//modules/safer-cluster-update-variant"
  version = "~> 11.1.0"

  # Required.
  name               = "mystudies-stg-gke-cluster"
  project_id         = module.project.project_id
  region             = "asia-northeast1"
  regional           = true
  network_project_id = "mystudies-stg-networks"

  network                = "mystudies-stg-network"
  subnetwork             = "mystudies-stg-gke-subnet"
  ip_range_pods          = "mystudies-stg-pods-range"
  ip_range_services      = "mystudies-stg-services-range"
...
module "project_iam_members" {
  ...
  bindings = {
    "roles/logging.logWriter" = [
      "serviceAccount:${google_service_account.auth_server_gke_sa.account_id}@mystudies-stg-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.hydra_gke_sa.account_id}@mystudies-stg-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.response_datastore_gke_sa.account_id}@mystudies-stg-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.study_builder_gke_sa.account_id}@mystudies-stg-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.study_datastore_gke_sa.account_id}@mystudies-stg-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.consent_datastore_gke_sa.account_id}@mystudies-stg-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.enroll_datastore_gke_sa.account_id}@mystudies-stg-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.user_datastore_gke_sa.account_id}@mystudies-stg-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.participant_manager_gke_sa.account_id}@mystudies-stg-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.triggers_pubsub_handler_gke_sa.account_id}@mystudies-stg-apps.iam.gserviceaccount.com",
    ],
  }
}
